...
void P_CloseWeapons(void) {
	...
	if (!deathmatch && P_Random() < 64) { /* Sometimes doesn't show up if not in deathmatch */
		return;
	}
	spot = P_Random() % MaceSpotCount;
...
void P_SetPsprite(player_t* player, int position, statenum_t stnum) {
	...
	do {
		...
		if (state->action.acp2) { /* Call action routine. */
...
boolean P_CheckAmmo(player_t* player) {
	...
	do {
		if (player->weaponowned[wp_skullrod] && player->ammo[am_skullrod] > ammoUse[wp_skullrod]) {
...
void P_FireWeapon(player_t* player) {
	...
	attackState = player->refire ? static_cast<statenum_t>(wpinfo[player->readyweapon].holdatkstate)
								 : static_cast<statenum_t>(wpinfo[player->readyweapon].atkstate);
	P_SetPsprite(player, ps_weapon, attackState);
	P_NoiseAlert(player->mo, player->mo);
	if (player->readyweapon == wp_gauntlets && !player->refire) { /* Play the sound for the initial gauntlet attack */
...
void A_WeaponReady(player_t* player, pspdef_t* psp) {
	...
	if ((player->readyweapon == wp_staff) && (psp->state == &states[S_STAFFREADY2_1]) && P_Random() < 128) {
...
/*
  ...
  //---------------------------------------------------------------------------
*/
void A_BeakReady(player_t* player, [[maybe_unused]] pspdef_t* psp) {
	if (player->cmd.buttons & BT_ATTACK) { /* Chicken beak attack */
		...
		if (player->mo->state == &states[S_CHICPLAY_ATK1]) { /* Take out of attack state */
...
void A_Lower(player_t* player, pspdef_t* psp) {
	...
	if (player->playerstate == PST_DEAD) { /* Player is dead, so don't bring up a pending weapon */
		psp->sy = WEAPONBOTTOM;
		return;
	}
...
/*
  ...
  //----------------------------------------------------------------------------
*/
void A_StaffAttackPL1(player_t* player, [[maybe_unused]] pspdef_t* psp) {
	angle_t angle;
	int damage;
	int slope;
...
/*
  ...
  //----------------------------------------------------------------------------
*/
void A_StaffAttackPL2(player_t* player, [[maybe_unused]] pspdef_t* psp) {
	angle_t angle;
	int damage;
	int slope;
...
/*
  ...
  //----------------------------------------------------------------------------
*/
void A_FireBlasterPL1(player_t* player, [[maybe_unused]] pspdef_t* psp) {
	mobj_t* mo;
	angle_t angle;
	int damage;
...
/*
  ...
  //----------------------------------------------------------------------------
*/
void A_FireBlasterPL2(player_t* player, [[maybe_unused]] pspdef_t* psp) {
	mobj_t* mo;
...
/*
  ...
  //----------------------------------------------------------------------------
*/
void A_FireGoldWandPL1(player_t* player, [[maybe_unused]] pspdef_t* psp) {
	mobj_t* mo;
	angle_t angle;
	int damage;
...
/*
  ...
  //----------------------------------------------------------------------------
*/
void A_FireGoldWandPL2(player_t* player, [[maybe_unused]] pspdef_t* psp) {
	int i;
	mobj_t* mo;
	angle_t angle;
	int damage;
...
/*
  ...
  //----------------------------------------------------------------------------
*/
void A_FireMacePL1B(player_t* player, [[maybe_unused]] pspdef_t* psp) {
	mobj_t* pmo;
	mobj_t* ball;
	angle_t angle;
	...
	pmo = player->mo;
	ball = P_SpawnMobj(
		pmo->x, pmo->y, pmo->z + 28 * FRACUNIT - FOOTCLIPSIZE * ((pmo->flags2 & MF2_FEETARECLIPPED) != 0), MT_MACEFX2);
...
void A_MaceBallImpact(mobj_t* ball) {
	if ((ball->z <= ball->floorz) && (P_HitFloor(ball) != FLOOR_SOLID)) { /* Landed in some sort of liquid */
		P_RemoveMobj(ball);
		return;
	}
	if ((ball->health != MAGIC_JUNK) && (ball->z <= ball->floorz) && ball->momz) { /* Bounce */
...
/*
  ...
  //----------------------------------------------------------------------------
*/
void A_FireMacePL2(player_t* player, [[maybe_unused]] pspdef_t* psp) {
	mobj_t* mo;
...
/*
  ...
  //----------------------------------------------------------------------------
*/
void A_FireCrossbowPL1(player_t* player, [[maybe_unused]] pspdef_t* psp) {
	mobj_t* pmo;
...
/*
  ...
  //----------------------------------------------------------------------------
*/
void A_FireCrossbowPL2(player_t* player, [[maybe_unused]] pspdef_t* psp) {
	mobj_t* pmo;
...
/*
  ...
  //----------------------------------------------------------------------------
*/
void A_FireSkullRodPL1(player_t* player, [[maybe_unused]] pspdef_t* psp) {
	mobj_t* mo;
...
/*
  ...
  //----------------------------------------------------------------------------
*/
void A_FireSkullRodPL2(player_t* player, [[maybe_unused]] pspdef_t* psp) {
...
void A_SkullRodStorm(mobj_t* actor) {
	...
	mo = P_SpawnMobj(x, y, ONCEILINGZ, static_cast<mobjtype_t>(MT_RAINPLR1 + actor->special2));
...
void A_RainImpact(mobj_t* actor) {
	if (actor->z > actor->floorz) {
		P_SetMobjState(actor, static_cast<statenum_t>(S_RAINAIRXPLR1_1 + actor->special2));
	} else if (P_Random() < 40) {
		P_HitFloor(actor);
	}
}
...
/*
  ...
  //----------------------------------------------------------------------------
*/
void A_FirePhoenixPL1(player_t* player, [[maybe_unused]] pspdef_t* psp) {
	angle_t angle;
...
/*
  ...
  //----------------------------------------------------------------------------
*/
void A_InitPhoenixPL2(player_t* player, [[maybe_unused]] pspdef_t* psp) {
...
/*
  ...
  //----------------------------------------------------------------------------
*/
void A_FirePhoenixPL2(player_t* player, [[maybe_unused]] pspdef_t* psp) {
	mobj_t* mo;
	mobj_t* pmo;
	angle_t angle;
	fixed_t x, y, z;
...
/*
  ...
  //----------------------------------------------------------------------------
*/
void A_ShutdownPhoenixPL2(player_t* player, [[maybe_unused]] pspdef_t* psp) {
