...
void R_InitTextures(void) {
  ...
  */
	...
	textures = static_cast<texture_t**>(Z_Malloc(numtextures * sizeof(void*), PU_STATIC, 0));
	texturecolumnlump = static_cast<short**>(Z_Malloc(numtextures * sizeof(void*), PU_STATIC, 0));
	texturecolumnofs = static_cast<unsigned short**>(Z_Malloc(numtextures * sizeof(void*), PU_STATIC, 0));
	texturecomposite = static_cast<byte**>(Z_Malloc(numtextures * sizeof(void*), PU_STATIC, 0));
	texturecompositesize = static_cast<int*>(Z_Malloc(numtextures * sizeof(void*), PU_STATIC, 0));
	texturewidthmask = static_cast<int*>(Z_Malloc(numtextures * sizeof(void*), PU_STATIC, 0));
	textureheight = static_cast<fixed_t*>(Z_Malloc(numtextures * sizeof(void*), PU_STATIC, 0));
   ...
   */
	texturetranslation = static_cast<int*>(Z_Malloc((numtextures + 1) * sizeof(void*), PU_STATIC, 0));
	for (i = 0; i < numtextures; i++)
...
void R_InitFlats(void) {
	...
	/* translation table for global animation */
	flattranslation = static_cast<int*>(Z_Malloc((numflats + 1) * sizeof(void*), PU_STATIC, 0));
...
void R_InitSpriteLumps(void) {
	...
	spritewidth = static_cast<fixed_t*>(Z_Malloc(numspritelumps * sizeof(void*), PU_STATIC, 0));
	spriteoffset = static_cast<fixed_t*>(Z_Malloc(numspritelumps * sizeof(void*), PU_STATIC, 0));
	spritetopoffset = static_cast<fixed_t*>(Z_Malloc(numspritelumps * sizeof(void*), PU_STATIC, 0));
