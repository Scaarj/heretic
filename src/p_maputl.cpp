...
void P_UnsetThingPosition(mobj_t* thing) {
	...
	if (!(thing->flags & MF_NOSECTOR)) { /* inert things don't need to be in blockmap */
	...
	if (!(thing->flags & MF_NOBLOCKMAP)) { /* inert things don't need to be in blockmap */
...
void P_SetThingPosition(mobj_t* thing) {
   ...
   */
	...
	thing->subsector = ss;
	if (!(thing->flags & MF_NOSECTOR)) { /* invisible things don't go into the sector links */
		sec = ss->sector;
