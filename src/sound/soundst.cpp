...
/* Purpose? */
[[maybe_unused]] const char snd_prefixen[] = {'P', 'P', 'A', 'S', 'S', 'S', 'M', 'M', 'M', 'S', 'S', 'S'};
...
[[maybe_unused]] static channel_t* channels;
...
[[maybe_unused]] static boolean mus_paused;

/* music currently being played */
[[maybe_unused]] static musicinfo_t* mus_playing = 0;
...
[[maybe_unused]] static int nextcleanup;
 ...
 */
void S_Init([[maybe_unused]] int sfxVolume, [[maybe_unused]] int musicVolume) {
	//	int i;
	...
	//			lumpinfo[genmidi_lumpno].position, W_LumpLength(genmidi_lumpno));
...
void S_StartSoundAtVolume([[maybe_unused]] void* origin_p, [[maybe_unused]] int sfx_id, [[maybe_unused]] int volume) {
	//	int rc;
	//	int sep;
	//	int pitch;
	//	int priority;
	...
	//	if (sfx_id >= sfx_gntact && sfx_id <= sfx_phohit) {
	//		pitch += 8 - (M_Random() & 15);
	...
	//		else if (pitch > 255)
	//			pitch = 255;
	//	} else if (sfx_id != sfx_itemup && sfx_id != sfx_stnmov) {
...
void S_StartSound([[maybe_unused]] void* origin, [[maybe_unused]] int sfx_id) {
	//	S_StartSoundAtVolume(origin, sfx_id, snd_SfxVolume);
}

void S_StopSound([[maybe_unused]] void* origin) {
	//	int cnum;
 ...
 */
void S_UpdateSounds([[maybe_unused]] void* listener_p) {
	//	int audible;
	//	int cnum;
	//	int volume;
	//	int sep;
...
void S_SetMusicVolume([[maybe_unused]] int volume) {
...
void S_SetSfxVolume([[maybe_unused]] int volume) {
	//	if (volume < 0 || volume > 127)
 ...
 */
void S_StartMusic([[maybe_unused]] int m_id) {
	//	S_ChangeMusic(m_id, false);
}

void S_ChangeMusic([[maybe_unused]] int musicnum, [[maybe_unused]] int looping) {
	//	musicinfo_t* music = 0;
	//	char namebuf[9];
...
void S_StopChannel([[maybe_unused]] int cnum) {
	//	int i;
 ...
 */
int S_AdjustSoundParams([[maybe_unused]] mobj_t* listener, [[maybe_unused]] mobj_t* source, [[maybe_unused]] int* vol,
	[[maybe_unused]] int* sep, [[maybe_unused]] int* pitch) {
	//	fixed_t approx_dist;
	//	fixed_t adx;
	//	fixed_t ady;
	//	angle_t angle;
 ...
 */
int S_getChannel([[maybe_unused]] void* origin, [[maybe_unused]] sfxinfo_t* sfxinfo) {
